    ...
    if ($isValid) {
        ...
        try {
            ...
            if ($conn != null) {
                ...
                $sql = "INSERT INTO registration (userName, password, firstName, lastName, address1, address2, city, state, zipCode, phone, email, gender, maritalStatus, dateOfBirth) VALUES (" . sprintf("'%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s'", $username, $password, $nameFirst, $nameLast, $address1, $address2, $city, $state, $zipcode, $phone, $email, $gender, $maritalStatus, date("Y-m-d", strtotime($birthDate))) . ")";
