                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                if (isset($_POST['inputUsername'])) {
                                    echo "<br/> Username: " . $_POST["inputUsername"] . "<br/>";
                                }
                                if (isset($_POST['inputPassword'])) {
                                    echo "<br/> Password: " . $_POST["inputPassword"] . "<br/>";
                                }
                                if (isset($_POST['inputConfirm'])) {
                                    echo "<br/> Confirm Password: " . $_POST["inputConfirm"] . "<br/>";
                                }
                                if (isset($_POST['inputNameFirst'])) {
                                    echo "<br/> First Name: " . $_POST["inputNameFirst"] . "<br/>";
                                }
                                if (isset($_POST['inputNameLast'])) {
                                    echo "<br/> Last Name: " . $_POST["inputNameLast"] . "<br/>";
                                }
                                ?>
                                <br/>
                            </div>
                            <div class="col-md-6">
                                <br/>
                                <?php 
                                if (isset($_POST['inputAddress1'])) {
                                    echo "<br/> Address Line 1: " . $_POST["inputAddress1"] . "<br/>";
                                }
                                if (isset($_POST['inputAddress2'])) {
                                    echo "<br/> Address Line 2: " . $_POST["inputAddress2"] . "<br/>";
                                }
                                if (isset($_POST['inputCity'])) {
                                    echo "<br/> City: " . $_POST["inputCity"] . "<br/>";
                                }
                                if (isset($_POST['inputState'])) {
                                    echo "<br/> State: " . $_POST["inputState"] . "<br/>";
                                }
                                if (isset($_POST['inputZipcode'])) {
                                    echo "<br/> Zipcode: " . $_POST["inputZipcode"] . "<br/>";
                                }
                                if (isset($_POST['inputPhone'])) {
                                    echo "<br/> Phone: " . $_POST["inputPhone"] . "<br/>";
                                }
                                if (isset($_POST['inputEmail'])) {
                                    echo "<br/> Email: " . $_POST["inputEmail"] . "<br/>";
                                }
                                if (isset($_POST['inputGender'])) {
                                    echo "<br/> Gender: " . $_POST["inputGender"] . "<br/>";
                                }
                                if (isset($_POST['inputMaritalStatus'])) {
                                    echo "<br/> Marital Status: " . $_POST["inputMaritalStatus"] . "<br/>";
                                }
                                if (isset($_POST['inputBirthDate'])) {
                                    echo "<br/> Date of Birth: " . $_POST["inputBirthDate"] . "<br/>";
                                }
                                ?>
                                <br/>
                            </div>
